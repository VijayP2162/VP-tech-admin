                              ...
                              <div class="col-lg-6 py-lg-5">
                                   <div class="d-flex flex-column h-100 justify-content-center">
                                        ...
                                        <div>
                                             ...
                                             <form action="{{url('/loginRegisteration')}}" method="post">
                                                  @csrf
                                                  <div class="mb-3">
                                                       <label class="form-label" for="example-name">Name</label>
                                                       <input type="name" id="example-name" name="username" class="form-control" placeholder="Enter your name">
                                                  </div>
                                                  <div class="mb-3">
                                                  ...
                                                  <div class="mb-3">
                                                       ...
                                                       <input type="text" id="" name="password" class="form-control" placeholder="Enter your password">
                                                  </div>
                                                  <div class="mb-3">
                                                       <label class="form-label" for="">Confirm Password</label>
                                                       <input type="text" id="" name="confirmpass" class="form-control" placeholder="Enter your confirm password">
                                                  </div>

                                                  <div class="mb-3">
                                                       <label class="form-label" for="">Mobile</label>
                                                       <input type="text" id="" name="mobile" class="form-control" placeholder="Enter your mobile" pattern="[0-9]{10}">
                                                  </div>
